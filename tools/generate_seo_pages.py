...
# none of this file's 14 page_shell() call sites need to know about it.
...
def _active_tab_for(canonical):
    if canonical == '/rekord/':
        return 'rekord'
    if canonical.startswith('/vreme/') or canonical.startswith('/pojavi/') or canonical.startswith('/slovar/'):
        return 'arhiv'
    return None
