...
.gp-chip{flex:0 0 auto;display:flex;align-items:center;gap:.4rem;background:var(--badge-bg);
  ...
  min-height:2.5rem;transition:border-color .15s ease,background .15s ease}
...
.gp-quicknav{display:flex;gap:.45rem;overflow-x:auto;padding:.65rem 0;
  scrollbar-width:thin;-webkit-overflow-scrolling:touch}
.gp-quicknav::-webkit-scrollbar{height:4px}
.gp-quicknav::-webkit-scrollbar-thumb{background:var(--card-border);border-radius:4px}
...
@media (max-width:760px){
  ...
  body .wrap{padding-bottom:9.7rem;padding-top:3.5rem}
  ...
  .gp-sos-fab{top:9.2rem;bottom:auto;right:.8rem;width:2.6rem;height:2.6rem;font-size:1.15rem}
